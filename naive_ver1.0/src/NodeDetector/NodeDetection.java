...
public class NodeDetection {
	...
	public void NodeDectector(LinkedHashMap<String, LinkedHashSet<String>> splitSentence_for_each_line,
			String UMLSDictionaryPath, String TriggerDictionaryPath, String EntityOneDictionaryPath, String AnnFileFolder_Function, String AnnFileFolder_Moa, String AnnFileFolder_Toxicity) throws Exception {
